class Memes {
  ...
  Memes({required this.id, required this.url, required this.top_text, required this.bottom_text, required this.date, required this.likes,  required this.user_id});
